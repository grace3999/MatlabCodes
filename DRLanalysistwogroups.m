...
for i=2;
    ...
    %%
%         %DRL resets 30sec
%         DRL(i).Animal(j).DRLresets30=nan(1,1,length(DRL(i).Animal(j).behavsessionlist));
%         DRL(i).Animal(j).DRLresetsmean30={};
%         %DRL reinforcement delivery 30sec
%         DRL(i).Animal(j).DRLpellets30=nan(1,1,length(DRL(i).Animal(j).behavsessionlist));
%         DRL(i).Animal(j).DRLpelletsmean30={};
%         %DRL lever presses right 30sec
%         DRL(i).Animal(j).DRLpressright30=nan(1,1,length(DRL(i).Animal(j).behavsessionlist));
%         DRL(i).Animal(j).DRLpressrightmean30={};
%         %DRL lever presses left 30sec 
%         DRL(i).Animal(j).DRLpressleft30=nan(1,1,length(DRL(i).Animal(j).behavsessionlist));
%         DRL(i).Animal(j).DRLpressleftmean30={};
%         %DRL effective lever presses left 30sec 
%         DRL(i).Animal(j).DRLeffectivepressleft30=nan(1,1,length(DRL(i).Animal(j).behavsessionlist));
%         DRL(i).Animal(j).DRLeffectivepressleftmean30={};
%         %DRL effective lever presses right 30sec 
%         DRL(i).Animal(j).DRLeffectivepressright30=nan(1,1,length(DRL(i).Animal(j).behavsessionlist));
%         DRL(i).Animal(j).DRLeffectivepressrightmean30={};
%         for k=16:20
%             %DRL resets 30sec
%             DRL(i).Animal(j).DRLresets30(:,:,k)=length(find(DRL(i).Animal(j).behavior(:,1,k)==37));
%             DRL(i).Animal(j).DRLresetsmean30=nanmean(DRL(i).Animal(j).DRLresets30(:,:,16:20));
%             %DRL reinforcement delivery 30sec
%             DRL(i).Animal(j).DRLpellets30(:,:,k)=length(find(DRL(i).Animal(j).behavior(:,1,k)==5));
%             DRL(i).Animal(j).DRLpelletsmean30=nanmean(DRL(i).Animal(j).DRLpellets30(:,:,16:20));
%             %DRL lever presses right 30sec
%             DRL(i).Animal(j).DRLpressright30(:,:,k)=length(find(DRL(i).Animal(j).behavior(:,1,k)==1));
%             DRL(i).Animal(j).DRLpressrightmean30=nanmean(DRL(i).Animal(j).DRLpressright30(:,:,16:20));
%             %DRL lever presses left 30sec 
%             DRL(i).Animal(j).DRLpressleft30(:,:,k)=length(find(DRL(i).Animal(j).behavior(:,1,k)==2));
%             DRL(i).Animal(j).DRLpressleftmean30=nanmean(DRL(i).Animal(j).DRLpressleft30(:,:,16:20));
%             %DRL effective lever presses left 30sec 
%             DRL(i).Animal(j).DRLeffectivepressleft30(:,:,k)=(DRL(i).Animal(j).DRLpellets30(:,:,k)./DRL(i).Animal(j).DRLpressleft30(:,:,k)).*100;
%             DRL(i).Animal(j).DRLeffectivepressleftmean30=nanmean(DRL(i).Animal(j).DRLeffectivepressleft30(:,:,16:20));
%             %DRL effective lever presses right 30sec 
%             DRL(i).Animal(j).DRLeffectivepressright30(:,:,k)=(DRL(i).Animal(j).DRLpellets30(:,:,k)./DRL(i).Animal(j).DRLpressright30(:,:,k)).*100;
%             DRL(i).Animal(j).DRLeffectivepressrightmean30=nanmean(DRL(i).Animal(j).DRLeffectivepressright30(:,:,16:20));
%         end
%     end
% end
